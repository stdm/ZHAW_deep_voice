...
class SpectrogramCnn470(SpectrogramCnn):
    def create_paper(self, shape):
        paper = [
            ...
            # dense layer
            (layers.DenseLayer, {'num_units': 4700}),
            (layers.DropoutLayer, {}),
            (layers.DenseLayer, {'num_units': 2350}),

            # output layer
            (layers.DenseLayer, {'num_units': 470, 'nonlinearity': nonlinearities.softmax})
        ]
