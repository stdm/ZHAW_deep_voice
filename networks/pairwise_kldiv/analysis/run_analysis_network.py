...
def run_analysis_network(network_file, X_train, y_train, speaker_list_train, X_test, y_test, speaker_list_test, conv_network_file=None, save_data_file=None):
    ...
    X_train, y_train, speaker_names_train = clustering_network.generate_output(X_train, y_train, speaker_list_train, network_params_file_in=network_file,
    ...
    X_test, y_test, speaker_names_test = clustering_network.generate_output(X_test, y_test, speaker_list_test, network_params_file_in=network_file,
                                                                            output_file_out=None,
                                                                            network_fun=network_factory.create_network_100_speakers,
                                                                            get_conv_output=get_conv_output,
                                                                            output_layer=7)
