...
if __name__ == "__main__":
    ...
    generate_cluster_output('20170425_lstm2_dense_kld_100batch', 'test_speakers_80_clustering',
                            '20170425_lstm2_dense_kld_100batch_test_cluster_80.pickel', True, True, True)
