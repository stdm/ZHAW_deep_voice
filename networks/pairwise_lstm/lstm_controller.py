...
class LSTMController(NetworkController):
    ...
    def get_embeddings(self):
        ...
        x_test, speakers_test = load_and_prepare_data(self.get_validation_test_data(), seg_size)
        x_train, speakers_train = load_and_prepare_data(self.get_validation_train_data(), seg_size)
