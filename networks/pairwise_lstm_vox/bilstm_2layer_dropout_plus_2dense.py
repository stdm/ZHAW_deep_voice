...
class bilstm_2layer_dropout(object):
    ...
    def fit(self, model, calls, X_t, y_t, X_v, y_v, epochs_to_run):
    ...
    def run_network(self):
        ...
        # initial train
        self.fit(model, global_calls, X_t, y_t, X_v, y_v, self.epochs_before_active_learning)
        ...
        for i in range(self.active_learning_rounds): 
            ...
            self.fit(model, calls, X_t, y_t, X_v, y_v, epochs_to_run)
