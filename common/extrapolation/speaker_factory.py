...
def create_all_speakers():
    ...
    yield Speaker(True, 100, 'speakers_100_50w_50m_not_reynolds', dataset="timit")
    ...
    yield Speaker(True, 100, "vox2_speakers_100_distinct_vox2_speakers_40", dataset="voxceleb2", max_audio_length=6600)
